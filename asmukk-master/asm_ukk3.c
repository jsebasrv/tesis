...
int align_W3(wchar_t **X, wchar_t **Y, wchar_t *a, wchar_t *b, int *W, int m_r, int n_c, int w_len, int (*score_func)(wchar_t, wchar_t), wchar_t gap_char) {
  int i;
  int dr, dc;
  int r, c, w;
...
int sa_align_ukk3(wchar_t **X, wchar_t **Y, wchar_t *a, wchar_t *b, int T, int (*score_func)(wchar_t, wchar_t), wchar_t gap_char) {
  int ret;
