...
int default_score(wchar_t x, wchar_t y) {
...
void debug_print_W2(int *W, int m_r, int w_len, wchar_t *a, wchar_t *b) {
  int r, w, n_c, c;
...
//
int align_W(wchar_t **X, wchar_t **Y, wchar_t *a, wchar_t *b, int *W, int m_r, int n_c, int w_len, wchar_t gap_char) {
  int i;
  int dr, dc;
  int r, c, w;
  ...
  *Y = NULL;
  ...
  tx = (wchar_t *)malloc(sizeof(wchar_t)*2*i);
  ty = (wchar_t *)malloc(sizeof(wchar_t)*2*i);
...
int align_W2(wchar_t **X, wchar_t **Y, wchar_t *a, wchar_t *b, int *W, int m_r, int n_c, int w_len, int mismatch, int gap, wchar_t gap_char) {
  int i;
  int dr, dc;
  int r, c, w;
  int pos00, pos01, pos10, pos11;
...
int asm_ukk_score(wchar_t *a, wchar_t *b) {
  int threshold = (1<<2);
...
int asm_ukk_score2(wchar_t *a, wchar_t *b, int mismatch, int gap) {
  int threshold = (1<<2);
  int it, max_it=(1<<(32-2-1));
  int sc = -2;
...
int asm_ukk_align(wchar_t **X, wchar_t **Y, wchar_t *a, wchar_t *b) {
  int threshold = (1<<2);
  int it, max_it=(1<<(32-2-1));
  int sc = -2;
...
int sa_align_ukk2(wchar_t **X, wchar_t **Y, wchar_t *a, wchar_t *b, int T, int mismatch, int gap, wchar_t gap_char) {
  int ret;
...
int sa_align_ukk(wchar_t **X, wchar_t **Y, wchar_t *a, wchar_t *b, int T) {
  int r,c, n_c, m_r, len_ovf;
  int *W, w, w_offset, w_len;
  int p, del, m;
  int create_align_seq = 0;
